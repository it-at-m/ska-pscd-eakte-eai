package de.muenchen.oss.ska_pscd_eakte_eai.swimdms.application.usecase;

import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.application.usecase.helper.DmsHelper;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.application.usecase.helper.TargetResolverHelper;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.configuration.DmsMeter;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.configuration.DmsProperties;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.domain.helper.DmsMetadataHelper;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.domain.model.DmsTarget;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.domain.model.LoadedFile;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.domain.model.UseCase;
import de.muenchen.oss.ska_pscd_eakte_eai.swimdms.domain.model.UseCaseType;
import de.muenchen.oss.ska_pscd_eakte_eai.swimLibs.handlercore.application.port.in.ProcessFileInPort;
import de.muenchen.oss.ska_pscd_eakte_eai.swimLibs.handlercore.application.port.out.FileEventOutPort;
import de.muenchen.oss.ska_pscd_eakte_eai.swimLibs.handlercore.application.port.out.FileSystemOutPort;
...
import de.muenchen.oss.ska_pscd_eakte_eai.swimLibs.handlercore.domain.model.PresignedFile;
...
public class ProcessFileUseCase implements ProcessFileInPort {
    ...
    public void processEvent(final MultiFileEvent event) throws PresignedUrlException, UnknownUseCaseException, MetadataException {
        final UseCase useCase = dmsProperties.findUseCase(event.useCase());
