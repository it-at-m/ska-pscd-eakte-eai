package de.muenchen.oss.pscdeakte.service;
...
import de.muenchen.oss.pscdeakte.DuplicateOrUpdate;
    ...
    public void saveFileToDb(final String filename) {
        ...
        try {
            ...
            final Iterable<CSVRecord> records =
                    csvFormat.parse(new InputStreamReader(s3.getFileContent(fileReference), StandardCharsets.ISO_8859_1));
            for (final CSVRecord rec : records) {
                processCSVRecord(rec);
            }
